...
public class UserController {
	...
	@GetMapping("/usersbyemail/{userEmail}/{userPassword}")
	public User getUserByUserEmailandUserPassword(@PathVariable String userEmail,@PathVariable String userPassword) {
